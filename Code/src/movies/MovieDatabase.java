...
//		movieList.add(new Movie("Frozen 2", "Sypnosis: Elsa the Snow Queen and her sister Anna embark on an adventure far away from the kingdom of Arendelle. They are joined by friends, Kristoff, Olaf, and Sven.", MovieStatus.PREVIEW));
